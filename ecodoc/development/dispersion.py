...
class PointSource:
    ...
    # Коэффициент стратификации атмосферы (МРР-2017, п. 5.2):
    #   140 — Центральная часть ЕТР (Московская, Тульская, Рязанская,
    #         Владимирская, Калужская, Ивановская обл.);
    #   160 — ЕТР и Урал севернее 52° с.ш., кроме центра (в т.ч. СПб и ЛО);
    #   180 — ЕТР и Урал южнее 52° с.ш., кроме центра;
    #   200 — Азиатская часть, Нижнее Поволжье, Кавказ.
    A: float = 160.0       # по умолчанию — Санкт-Петербург и Ленобласть
