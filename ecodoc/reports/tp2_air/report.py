...
ВНИМАНИЕ: текущая печать/XML используют графы «в пределах норматива/лимита/
сверх» — это графы ДЕКЛАРАЦИИ О ПЛАТЕ, в форме 2-ТП (воздух) их НЕТ. Действующая
форма — адресная часть + 5 разделов; Раздел 1 агрегирует вещества в 9 строк
(101 Всего; 102 твёрдые; 103 газообразные/жидкие; 104 SO2; 105 CO; 106 NOx;
107 углеводороды без ЛОС; 108 ЛОС; 109 прочие) с графами потока очистки
(отходит / без очистки / на очистные / уловлено-обезврежено / утилизировано /
выброшено); Раздел 2 — специфические вещества (вне перечня — код 8888);
Раздел 3 — источники загрязнения. Требуется переработка структуры.
