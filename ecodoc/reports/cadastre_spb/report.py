...
Сдаётся в Комитет подписанным файлом Excel (.xlsx + .sig), XML-выгрузки нет.
Срок — региональный (ориентир — до 1 марта, сверять с порталом Комитета).
...
class CadastreSPB(Report):
    ...
    def validate(self) -> list[Issue]:
        ...
        issues.append(Issue("warning", "срок",
                            "срок подачи кадастра региональный — сверьте с порталом Комитета"))
        return issues
