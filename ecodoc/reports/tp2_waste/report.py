...
обезвреживании, транспортировании и размещении отходов (Приказ Росстата
от 09.10.2020 № 627, ранее № 529). Годовая, до 1 февраля, в ЛКПП РПН.

XML — конверт «Модуля природопользователя» (DATA_PACKET_NI, DocType=3),
печатная форма — три страницы бланка Росстата (стр.1 титул + код-строка,
стр.2 таблица движения с графами 1–18, стр.3 справочно + подпись).
