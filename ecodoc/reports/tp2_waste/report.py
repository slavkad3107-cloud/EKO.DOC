...
# незаполненные печатаются прочерком, как в принятых отчётах.
_S3_ROWS = [
    (11, "Количество эксплуатируемых респондентом объектов захоронения отходов, ед"),
    (12, "из них твёрдых коммунальных отходов, ед"),
    ...
    (15, "из них твёрдых коммунальных отходов, ед"),
    ...
    (30, "из них твёрдых коммунальных отходов, га"),
...
class TP2Waste(Report):
    ...
    def _page1(self, wb):
        ...
        xlsx.merge(ws, "A6:D7",
                   ...
                   "с ТКО  ·  Срок предоставления: 1 февраля после отчётного "
                   "периода  ·  Форма утверждена приказом Росстата "
