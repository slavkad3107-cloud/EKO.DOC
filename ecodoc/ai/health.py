...
def _reason(err: str) -> tuple[int, str]:
    ...
    # Mistral: модель не входит в бесплатный тариф — 429 с лимитом «0 запросов
    # в минуту» (отметку ставит _post по заголовку); ждать бесполезно, нужна
    # другая модель (бесплатные — ministral-14b/8b/3b, codestral)
    if "лимит тарифа: 0" in low:
        return code, "модель не входит в бесплатный тариф (лимит 0 запросов/мин)"
