...
NORMS: dict[str, dict] = {
    ...
    "4-oos": {
        "npa": "приказ Росстата от 22.07.2025 № 346 (с изм. № 566 от "
               "10.10.2025 и № 734 от 19.12.2025) — форма № 4-ОС, ОКУД 0609030",
        "effective": 2025,
        "marks": ["4-ос", "охран"],
    },
    "cadastre-spb": {
    ...
    "pnoolr": {
        "npa": "методические указания по разработке ПНООЛР (приказ "
               "Минприроды России от 07.12.2020 № 1021)",
        "effective": 2021,
